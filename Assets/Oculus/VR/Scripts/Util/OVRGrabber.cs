...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected bool m_beginMovement = false;
    protected bool m_beginRotation = false;
    /// <summary>
    ...
    {
		if (m_operatingWithoutOVRCameraRig && m_beginMovement)
        {
		    OnUpdatedAnchors();
        }
	}
    ...
    virtual public void OnUpdatedAnchors()
    {
        //Debug.Log("OnUpdatedAnchors Being Called");
        Vector3 destPos = m_parentTransform.TransformPoint(m_anchorOffsetPosition);
        Quaternion destRot = m_parentTransform.rotation.normalized * m_anchorOffsetRotation;
        ...
        {
            MoveGrabbedObject(destPos, destRot.normalized);
        }
    ...
    virtual public void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        if (m_grabbedObj == null)
        {
            return;

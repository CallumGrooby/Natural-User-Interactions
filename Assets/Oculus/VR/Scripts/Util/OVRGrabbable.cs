...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public InteractionType interactionMethod;
    ...
    public void ChangeMaterial(Material materialToChangeTo)
    {
        this.gameObject.GetComponent<Renderer>().material = materialToChangeTo;
    }
}
